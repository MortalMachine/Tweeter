...
/*
        ...
        Mockito.when(mockFollowGenerator.generateUsersAndFollowers(Mockito.anyInt(), Mockito.anyInt(), Mockito.anyInt(), (FollowGenerator.Sort) Mockito.any())).thenReturn(follows);
    ...
    void testGetFollowees_noFolloweesForUser() {
        ...
        Assertions.assertEquals(0, Model.getInstance().getFollowees(user1).size());
    ...
    void testGetFollowees_oneFollowerForUser_limitGreaterThanUsers() {
        ...
        Assertions.assertEquals(1, Model.getInstance().getFollowees(user9).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user9).contains(user5));
        Assertions.assertFalse(response.hasMorePages());
    }
    ...
    void testGetFollowees_twoFollowersForUser_limitEqualsUsers() {
        ...
        Assertions.assertEquals(2, Model.getInstance().getFollowees(user3).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user3).contains(user1));
        Assertions.assertTrue(Model.getInstance().getFollowees(user3).contains(user8));
        Assertions.assertFalse(response.hasMorePages());
    }
    ...
    void testGetFollowees_limitLessThanUsers_endsOnPageBoundary() {
        ...
        // Verify first page
        Assertions.assertEquals(2, Model.getInstance().getFollowees(user5).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user5).contains(user9));
        Assertions.assertTrue(Model.getInstance().getFollowees(user5).contains(user11));
        Assertions.assertTrue(response.hasMorePages());

        // Get and verify second page
        request = new FollowingRequest(user5, 2, Model.getInstance().getFollowees(user5).get(1));
        response = serverFacadeSpy.getFollowees(request);

        Assertions.assertEquals(2, Model.getInstance().getFollowees(user5).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user5).contains(user1));
        Assertions.assertTrue(Model.getInstance().getFollowees(user5).contains(user2));
        Assertions.assertTrue(response.hasMorePages());
        ...
        Assertions.assertEquals(2, Model.getInstance().getFollowees(user5).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user5).contains(user4));
        Assertions.assertTrue(Model.getInstance().getFollowees(user5).contains(user8));
        Assertions.assertFalse(response.hasMorePages());
    }
    ...
    void testGetFollowees_limitLessThanUsers_notEndsOnPageBoundary() {
        ...
        // Verify first page
        Assertions.assertEquals(2, Model.getInstance().getFollowees(user6).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user3));
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user5));
        Assertions.assertTrue(response.hasMorePages());

        // Get and verify second page
        request = new FollowingRequest(user6, 2, Model.getInstance().getFollowees(user6).get(1));
        response = serverFacadeSpy.getFollowees(request);

        Assertions.assertEquals(2, Model.getInstance().getFollowees(user6).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user1));
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user7));
        Assertions.assertTrue(response.hasMorePages());
        ...
        Assertions.assertEquals(2, Model.getInstance().getFollowees(user6).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user10));
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user12));
        Assertions.assertTrue(response.hasMorePages());
        ...
        Assertions.assertEquals(1, Model.getInstance().getFollowees(user6).size());
        Assertions.assertTrue(Model.getInstance().getFollowees(user6).contains(user4));
        Assertions.assertFalse(response.hasMorePages());
    }
*/
}
